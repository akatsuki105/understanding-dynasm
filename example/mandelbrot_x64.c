...
#endif
#line 39 "./example/mandelbrot.c"

  // dasm_Stateに実際にメモリを割り当てる
  //|.section code
#define DASM_SECTION_CODE	0
#define DASM_MAXSECTION		1
#line 42 "./example/mandelbrot.c"
...
#line 83 "./example/mandelbrot.c"
  
  dasm_State** Dst = &d;
  //|.code
  dasm_put(Dst, 0);
#line 86 "./example/mandelbrot.c"
  //|->bf_main:
  //| prologue
  //| mov aPtr, state->tape
